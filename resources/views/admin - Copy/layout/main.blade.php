...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Admin | Dapur Mama Inong</title>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		 ...
		 <!-- favicon -->
    	<link rel="shortcut icon" href="{{ asset('admin/assets/img/dapurmamainong.png') }}">

		<!-- bootstrap & fontawesome -->
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/css/bootstrap.min.css') }}" />
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/plugins/font-awesome-4.6.3/css/font-awesome.min.css') }}" />
		
		<!-- page specific plugin styles -->
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/plugins/chosen/css/chosen.min.css') }}" />
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/plugins/datepicker/css/datepicker.min.css') }}" />

		<!--fonts-->
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/fonts/fonts.googleapis.com.css') }}" />

		<!--ace styles-->
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/css/ace.min.css') }}" class="ace-main-stylesheet" id="main-ace-style" />
		<link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/js/ace-extra.min.js') }}" />
	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default navbar-collapse h-navbar navbar-fixed-top">
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="main.php?module=beranda" class="navbar-brand">
						<bigger>
							Admin - DAPUR MAMA INONG
						</bigger>
					</a>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							&copy; 2023 - DAPUR MAMA INONG. All Rights Reserved
						</span>
					</div>
				</div>
			</div>
		...
		<script src="{{ asset('admin/assets/plugins/chosen/js/chosen.jquery.min.js') }}"></script>
		...
		<script src="{{ asset('admin/assets/plugins/dataTables/jquery.dataTables.bootstrap.min.js') }}"></script>
