...
<head>
    ...
    <title>Login Admin | Dapur Mama Inong</title>
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <center>
                <img style="width:100px;" src="{{ asset('assets/img/logo.png') }}" />
            </center>
            <form action="{{ route('login') }}" method="post" class="login-form">
                @csrf
                <div class="form-group form-floating-label">
                    <input id="email_or_username" name="email_or_username" type="text"
